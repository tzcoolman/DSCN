...
############################################################
target_file="SL_human_WG.selected"
exp_file="cellline_exp.txt.selected"
essen_file="cellline.FC.selected"
ppi_file="string_PPI.network.selected"
cluster_file="TCGA_WG.cluster"
...
##p-value 
############################################################
	#DSCN_p.calculate_p(np.mean(score_list),np.std(score_list),op_num_1,bg_mu,bg_std,count)
############################################################
...
#############################################################
			...
			print (temp_total_list)
			print (bg_mu,bg_std,count)
			a=np.mean(temp_total_list)
			print (a)
			b=np.std(temp_total_list)
			print (b)
			c=len(temp_total_list)
			print (c)
			P_value=DSCN_p.calculate_p(a,b,c,bg_mu,bg_std,count)
#############################################################
###score 2nd target
#############################################################
